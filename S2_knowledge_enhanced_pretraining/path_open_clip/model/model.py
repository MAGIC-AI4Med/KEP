...
from .knowledge_bert import PATH_BERT
...
class KEP(nn.Module):
    ...
    def __init__(
        ...
        if self.text_encoder == 'bert':
            ...
            ## add text encoders you want here
            pass
    ...
    def encode_text(self, text, normalize: bool = False):
        if self.text_encoder  == 'bert':
            ...
            ## add other text encoders you want
            return 0
    ...
    def forward(
        ...
        text_clip = text
        text_knowledge = text
        if isinstance(text, dict) and 'text_clip' in text:
            text_clip = text['text_clip']
        if isinstance(text, dict) and 'text_knowledge' in text:
